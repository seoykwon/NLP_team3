...
# 간단한 통합 RAG QA 시스템 실행 스크립트

echo "🤖 간단한 통합 RAG QA 시스템 시작"
echo "================================"
...
echo ""
echo "🚀 간단한 RAG QA 시스템을 시작합니다..."
echo "   브라우저에서 http://localhost:8502 에 접속하세요"
echo ""

# Streamlit 앱 실행
cd "$SCRIPT_DIR"
python3 -m streamlit run main_simple.py --server.port 8502 --server.address localhost
